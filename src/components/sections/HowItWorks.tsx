      ...
      <div className="container">
        ...
        <div className="row align-items-center">
          <div className="col-md-6 col-xl-6">
            <a href={Content.button1.link} className="absolution-link absolution-mb-30">
          ...
          <div className="col-md-6 col-xl-6">
            <div className="absolution-adaptive-right">
              <a href={Content.button2.link} className="absolution-button absolution-border absolution-mb-30">
