...
const Solution1 = () => {
  return (
    <Layouts footer={2}>
        ...
        <div className="container">
          <div className="absolution-text-center absolution-mb-90">
            ...
            <h2>
              ...
              <span className="absolution-accent">Extensive Know How</span>
            </h2>
          </div>
        </div>
      </section>
      ...
      {/* ??? end */}
      {/* call to action */}
      <section className="call-to-action absolution-gradient-bg absolution-p-120-120">
        <div
        ...
        <div className="container absolution-text-center">
          <div className="absolution-cta-frame">
            <div className="absolution-icon-frame absolution-icon-frame-md absolution-mb-50">
              <img src="img/icons/md/13l.svg" alt="icon" />
            </div>
            <p className="absolution-light absolution-mb-30">Cybersecurity Ventures</p>
            <h3 className="absolution-light">
              The Estimated Global Cost of{" "}
              <span className="absolution-accent">Cybercrime</span> is{" "}
              <span className="absolution-accent">$6T</span> <br />
              and Climbing <span className="absolution-accent">+ 15%</span> a Year.
            </h3>
          </div>
        </div>
      </section>
      ...
      <section className="absolution-p-120-90">
        ...
        <div className="container">
          ...
          <h2 className="absolution-mb-90">
            AI Development <span className="absolution-accent">Tech Stack</span>
          </h2>
